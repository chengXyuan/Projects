package com.daking.lottery.widget.banner;
...
public class BannerView<Item> extends FrameLayout {
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int itemWidth = a.getLayoutDimension(0, mDm.widthPixels);
        int itemHeight1 = LayoutParams.WRAP_CONTENT;
        int itemHeight = a.getLayoutDimension(1, itemHeight1);
        a.recycle();

        if (itemWidth < 0) {
            itemWidth = mDm.widthPixels;
        }
        ...
        if (aspectRatio > 0) {
            ...
            itemHeight1 = (int) (itemWidth * aspectRatio);
        }

        Log.e(TAG, "w = " + itemWidth + ", h = " + itemHeight);
        LayoutParams lp = new LayoutParams(itemWidth, itemHeight1);
        ...
        addView(vBottomBar, new LayoutParams(itemWidth, LayoutParams.WRAP_CONTENT, Gravity.BOTTOM));
